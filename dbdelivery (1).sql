...
--
-- Host: 127.0.0.1
-- Tempo de geração: 19-Jun-2023 às 01:28
...
INSERT INTO `tbcliente` (`codcli`, `nome`, `cpf`, `fone`, `email`, `senha`, `nasc`, `CEP`, `estado`, `cidade`, `bairro`, `rua`, `numero`, `complemento`) VALUES
(1, 'Matheus Ravier Lima de Sousa', '171.977.510-98', '(99)99999-9999', 'admin@admin.com', 'mr123', '2023-06-16', '62030-233', 'Ceará|CE', 'Sobral', 'Campo dos Velhos', 'Avenida Doutor José Arimathéa Monte e Silva', 0, 'lado ímpar'),
(5, 'Mathias Rafael ', '642.791.250-07', '(55)94002-8922', 'mato@mato.com', '0987', '2015-01-19', '62030-975', 'Ceará|CE', 'Sobral', 'Junco', 'Avenida John Sanford', 0, '1800');
